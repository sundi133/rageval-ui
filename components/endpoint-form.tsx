...
export default function DatasetForm() {
  ...
  const [responsePayloadSample, setResponsePayloadSample] =
    useState<string>(''); // User-provided payload sample
...
`;
      ...
      if (payloadFormat === 'json') {
        setResponsePayloadSample(
          JSON.stringify(responseSamplePayload, null, 2)
        );
      } else {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        setSuccessMessage('Great, Your endpoint has been created');
          ...
          >
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className={`w-full border rounded p-2 ${
                  isEndpointValid ? 'border-red-500' : ''
                }`}
                required
              />
